...
class StoreComponentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'is_required' => ['sometimes', 'boolean'], 'is_sensitive' => ['sometimes', 'boolean'], 'visible' => ['sometimes', 'boolean'], 'max_points' => ['nullable', 'numeric', 'min:0', 'max:100000'], 'manual_grading' => ['sometimes', 'boolean'],
