...
class OrganisationController extends Controller
{
    ...
    public function destroy(Organisation $organisation, CleanupService $cleanup) { abort_unless(auth()->user()->isPlatformAdmin(),403);$cleanup->deleteOrganisation($organisation);return redirect()->route('organisations.index')->with('success',__('messages.organisation_deleted')); }
}
