...
@section('content')
<div class="page-header"><div><h1 class="page-title">{{ __('messages.anonymized_results') }}</h1><p><code>{{ $patientCode }}</code> · {{ $formName }}</p></div><a class="btn" href="{{ route('anonymized-results.index') }}">{{ __('messages.back') }}</a></div>
