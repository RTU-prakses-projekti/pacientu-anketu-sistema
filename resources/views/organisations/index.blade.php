@extends('layouts.app')
@section('content')
<div class="page-header"><h1 class="page-title">{{ __('messages.organisations') }}</h1><a class="btn primary" href="{{ route('organisations.create') }}">{{ __('messages.new_organisation') }}</a></div>
