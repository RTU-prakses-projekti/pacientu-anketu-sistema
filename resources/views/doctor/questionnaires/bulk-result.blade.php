...
@section('content')
<div class="page-header"><div><h1 class="page-title">{{ __('messages.bulk_links_ready') }}</h1><p>{{ __('messages.bulk_links_copy_now') }}</p></div><a class="btn" href="{{ route('doctor.dashboard', ['organisation_id' => $organisationId]) }}">{{ __('messages.back') }}</a></div>
