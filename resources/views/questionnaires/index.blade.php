...
@section('content')
<div class="page-header"><div><a href="{{ route('forms.index',$organisation) }}">{{ __('messages.back') }}</a><h1 class="page-title">{{ __('messages.import_questionnaire') }}</h1><p class="page-context">{{ __('messages.organisation') }}: {{ $organisation->name }}</p></div></div>
