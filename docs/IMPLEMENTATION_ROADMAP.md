...
7. Private attachments, CSV/XLSX exports, queues, and audit log.
8. Central LV/EN/RU content resolver, versioned FormVersion content, compact builder language tabs, localized read-only preview, and same-submission safe respondent language switching.
9. Automated workflow tests, k6 load script, documentation.
...
5. Commission professional LV/EN/RU content/UI translation review and add translation completeness gates.
