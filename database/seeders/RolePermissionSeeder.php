...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            ...
            'organisation_admin' => ['display_name'=>'Administratora palīgs','scope'=>'organisation','permissions'=>array_values(array_diff($permissions,['doctor.dashboard.view','patients.view','patients.update','patient.questionnaires.view']))],
            'form_creator' => ['display_name'=>'Anketu pārvaldnieks','scope'=>'organisation','permissions'=>['organisation.view','forms.view','forms.create','forms.update','forms.publish','forms.archive','submissions.view']],
